...
const Multiselect = ({tag, selectedTag, setSelectedTag}: any) => {
    ...
    const [items, setItems] = useState(['First Amendment', 'Accountability', 'Alternative Dispute Resolution', 'Anonymity', 'Applications', 'Artificial Intelligence', 'Blockchain', 'Browsers', 'Central Bank', 'Civil Liability', 'Commodities', 'Confidentiality', 'Compliance', 'Computational Security', 'Conflict Resolution Framework', 'Consent Management', 'Consumer Protection', 'Consensus', 'Crowdfunding', 'Cryptocurrency', 'Cryptography', 'Cybersecurity', 'DAO', 'Data Management', 'Data Provenance', 'DDOS Attacks', 'DeFi' ]);
